...
This sample demonstrates how to create automation in Slack using GitHub.
...
$ slack create my-app -t slack-samples/deno-github-functions
...
For an example of how to test a function, see `functions/create_issue_test.ts`.
